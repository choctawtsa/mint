  ...
  <div>
    ...
    >
      ...
      >
        ...
        <div class="pt-10 md:pt-12 xl:pt-16">
          ...
          <p class="text-teal-900 lg:text-xl">
    ...
    <main class="mt-6 pb-10">
      <section class="container mx-auto px-6">
        <div class="md:flex md:items-start xl:grid xl:grid-cols-12 gap-10">
          <div
          ...
          <div class="mt-6 md:mt-0 xl:col-span-9">
      ...
      <section class="container mx-auto mt-10 px-6">
        ...
        >
          <div
            ...
            style="background-image: url(https://images.unsplash.com/photo-1572317319594-85f16b62b93b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop)"
          ></div>
          <div
