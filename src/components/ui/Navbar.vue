<template>
  <header id="menu" class="fixed w-screen bg-white shadow-md top-0 left-0 z-50 sm:hidden">
    <div class="container mx-auto sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
      ...
      <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
        ...
        <router-link
          to="/dictionary"
          class="mt-1 block px-2 py-1 text-gray-700 rounded hover:bg-gray-200 sm:mt-0 sm:ml-2"
